...
const PlanesPage = () => {
  return (
    <>
     <h1 className="text-center text-8xl px-56 font-thin leading-tight mt-20">Conoce los <span className="font-medium bg-gradient-to-r from-purple-500 to-pink-400 bg-clip-text text-transparent">planes</span> y sus características.</h1>
     <Card className='mx-72   my-10'>
        ...
        <div className='flex justify-center'>
            <Button className='w-1/3 bg-gradient-lexify  hover:bg-gradient-lexify-hover transition-all cursor-pointer'><Link href="/traductor">Probar plan gratuito</Link></Button>
        </div>
     </Card>
